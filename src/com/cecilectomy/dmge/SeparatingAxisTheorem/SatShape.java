package com.cecilectomy.dmge.SeparatingAxisTheorem;
...
public class SatShape extends Polygon {
	...
	public SatShape(Rectangle r) {
		super(new int[] { r.x, r.x + r.width, r.x + r.width, r.x }, new int[] {
				r.y, r.y, r.y + r.height, r.y + r.height }, 4);
		x = r.x;
		y = r.y;
	}
	...
	public SatAxis getAxis(int i) {
		...
		Point p2 = new Point(xpoints[i + 1 == npoints ? 0 : i + 1],
				ypoints[i + 1 == npoints ? 0 : i + 1]);
