...
public class Entity implements Comparable<Entity> {
	 ...
	 * entity.
	 * <p>
	 * The filters and definitions arrays must be of equal length for the
	 * {@link EntityManager} to accept them during collision detection. If they
	 * are not of equal length, the {@link EntityManager} will ignore this
	 * entity outright and perform no collision detection.
	 * 
	 ...
	 * <p>
	 * When an Entity is inserted into an {@link EntityManager} a
	 ...
	 * <p>
	 * A value of 0 denotes an unspecified lifetime. The entity will live until
	 * you manually destroy it.
	 * 
	 * @param ls
	 *            new lifespan to give this entity.
	 */
	 ...
	 * <p>
	 * Event is only created if the specified Entity exists in THIS Entity's
