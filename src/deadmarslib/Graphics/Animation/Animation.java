 ...
 * <p>
 * This is a basic animation class based off of a now unknown tutorial from the Internet.
 * No idea where it came from, as it was ported over a year ago from a C# tutorial.
 * This will however be replaced with a much more robust set of Animation classes so it is
 * pointless to try and find and credit the original author. If you recognize the code
 * and it is truly yours, let me know (and give me credible source proof) and i will credit you.
 * 
 * @author Daniel Cecil
 */
public class Animation {
     ...
     * <p>
     * The source {@link Rectangle} specifies where on the image
     * texture to draw from based on dimensions and current frame number.
     * 
